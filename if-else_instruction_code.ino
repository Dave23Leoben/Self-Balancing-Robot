...
void loop() {
      ...
      Serial.println(" main code is running before if-else condition");
  ...
  Serial.println(" main code is still running before if-else condition");
...
LeftSensor = distance;
  ...
  if(LeftSensor<10) {
    ...
    Serial.println(" the robot is moving by left sensor");
    ...
    while (LeftSensor<10){
     ...
     Serial.println(" now the obstacole should be far from left sensor");
    ...
    Serial.println(" the robot is moving by right sensor");
      ...
      Serial.println(" now the obstacole should be far from right sensor");
